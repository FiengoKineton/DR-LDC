...
class YoungSchurNonconvexLikeDROLMI:
    """
    ...
    def build_var(self):
        ...
        DeltaA = cas.sym("DA", nx, nx)
        DeltaB = cas.sym("DB", nx, nu)
        ...
        while not STABLE and i<7:
            ...
            if not upd or not FROM_DATA:
                ...
                if not non_convex:
                    ...
                    real_Z_mats = False
                    dro = YoungSchurNonconvexLikeDROLMI(vals=(upd, FROM_DATA, vect, augmented, inp), model=model, N_sims=N_sims,
                            api=api, noise=noise, reg_fro=reg_fro, real_Z_mats=real_Z_mats)
