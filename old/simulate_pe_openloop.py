...
"""
python simulate_pe_openloop.py --T 3000 --nx 4 --nu 2 --nw 2 --ny 2 --nz 3 --input multisine --amp 1.0 --w_std 0.1 --seed 42 --out data/session01.csv
"""

def stable_A(nx, seed):
...
def synth_outputs_with_mats(X, U, R, ny, nz):
    """
...
def make_data():
    ...
    Y, Z, Cy, Dyw, Cz, Dzu, Dzw = synth_outputs_with_mats(X, U, R, ny=ny, nz=nz)
...
if __name__ == "__main__":
    #make_data()
    evaluate_from_path("data/session01.csv", truth_npz="data/session01_truth.npz", ridge=1e-6)
